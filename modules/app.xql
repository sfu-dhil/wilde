...
declare function app:browse($node as node(), $model as map(*)) as node() {
    ...
    return
        <table class='table table-striped table-hover table-condensed' id="tbl-browser" data-toggle="table" data-filter-control="true" data-filter-show-clear="true" data-search="true" data-show-export="true" data-click-to-select="true" data-pagination="true" data-total-field='total'>
            <thead>
                <tr>
